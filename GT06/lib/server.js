...
function Server(opts, callback) {
  ...
  this.init = function(cb) {
    ...
    if (typeof _this.opts.device_adapter === "string") {
      ...
      if (
        typeof this.availableAdapters[this.opts.device_adapter] === "undefined"
      )
        throw "The class adapter for " +
          this.opts.device_adapter +
          " doesn't exists";
    ...
    _this.server = net
      .createServer(function(connection) {
        ...
        connection.on("data", function(data) {
          if (!functions.invalid_data(data)) {
        ...
        connection.on("error", function(err) {
          ...
          errorLogger.error("Socket Error", err.message);
