...
var adapter = function (device) {
  ...
  this.parse_data = function (data) {
    ...
    if (parts['start'] == '7878') {
      ...
      //console.log('Protocol Id',parts['protocal_id'])
      ...
      if (parts['protocal_id'] == '01') {
        ...
        //console.log("Device Status",data.substr(8,2));
        parts['status']=data.substr(8,2),
        parts['device_id'] = '';
        parts.cmd = 'heartbeat';
  ...
  this.authorize = function () {
    ...
    //console.log("CRC REsult "+'7878' + str + crcResult + '0d0a')
  ...
  this.get_ping_data = function (msg_parts) {
    ...
    var infoTT = f.str_pad(parseInt(str.substr(54,2)).toString(2), 8, 0);
    //console.log(infoTT)
  ...
  this.get_status = function(msg_parts){
    var str = msg_parts.data;
    return msg_parts.status;
  }
